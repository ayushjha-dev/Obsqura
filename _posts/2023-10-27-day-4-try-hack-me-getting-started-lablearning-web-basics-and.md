...
image:
  ...
  alt: "Try Hack Me Getting Started Lab banner with code and interface elements."
---
...
![Joining the Getting Started Lab on Try Hack Me]({{ '/assets/img/posts/20231027/2-join-getting-started-lab.png' | relative_url }})
...
![Starting the target machine and Attack Box]({{ '/assets/img/posts/20231027/3-start-machine-and-attackbox.png' | relative_url }})
...
![Target machine information with IP address displayed]({{ '/assets/img/posts/20231027/4-target-machine-ip-address.png' | relative_url }})
...
![Accessing the target website using the IP in the Attack Box browser]({{ '/assets/img/posts/20231027/5-access-target-website-in-attackbox.png' | relative_url }})
...
![Right-clicking to view page source on the BFFs website]({{ '/assets/img/posts/20231027/6-viewing-page-source.png' | relative_url }})
...
![Finding the hidden admin page in the HTML source code comments]({{ '/assets/img/posts/20231027/7-hidden-admin-page-in-source.png' | relative_url }})
...
![Using default credentials to log in and answer questions]({{ '/assets/img/posts/20231027/8-identifying-application-users.png' | relative_url }})
...
![Getting Started lab completion screen on Try Hack Me]({{ '/assets/img/posts/20231027/9-lab-completion-screen.png' | relative_url }})
