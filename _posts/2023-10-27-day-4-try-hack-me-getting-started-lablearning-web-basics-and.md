...
author: ayushjha
image:
  path: /assets/img/posts/20231027/1-hero-banner.png
...
![The TryHackMe 'Getting Started' room page before joining.](/assets/img/posts/20231027/2-getting-started-room-page.png)
...
![The Target Machine Information banner showing the IP address is loading.](/assets/img/posts/20231027/3-target-machine-info-loading.png)
...
![The 'Active Machine Information' banner showing the target IP address.](/assets/img/posts/20231027/4-active-machine-information.png)
...
![Pasting the target IP address into the Firefox browser inside the Attack Box.](/assets/img/posts/20231027/5-accessing-target-in-attackbox.png)
...
![Right-clicking on the BFFs website to select 'View Page Source'.](/assets/img/posts/20231027/6-view-page-source-option.png)
...
![The HTML source code reveals a comment pointing to a hidden admin page.](/assets/img/posts/20231027/7-source-code-reveals-admin-page.png)
...
![Entering the default credentials 'admin:admin' into the login form.](/assets/img/posts/20231027/8-entering-default-credentials.png)
